...
⚠️ **WARNING:** Your copy may be tampered, corrupted, or counterfeit.
...
- [ ] **Source Verification:** Downloaded directly from authorized source
  - ✅ Authorized: Official website, licensed Git repository
  - ❌ Unauthorized: Public GitHub, file-sharing sites, torrents
...
- ❌ License activation script missing or disabled
- ❌ Generic/fake license keys (e.g., "XXXX-XXXX-XXXX-XXXX")
...
- ❌ `verify-authenticity.sh` script removed or bypassed

### 3. Digital Signatures
Releases are PGP-signed with our private key.

**Counterfeit indicators:**
- ❌ Missing `.sig` signature files
...
**Counterfeit indicators:**
- ❌ Metadata removed or altered
- ❌ RULES files copied from public repositories without authorization

### 5. Certificate Chain
This certificate references our official website and PGP key, both verifiable.

**Counterfeit indicators:**
- ❌ Certificate points to unknown/fake website
- ❌ PGP key fingerprint doesn't match official key

---

## 🛡️ WHAT TO DO IF YOU SUSPECT COUNTERFEITING
...
- ⚠️ Malware or backdoors
- ⚠️ Altered logic that breaks functionality
- ⚠️ Removed security protections
- ⚠️ Stolen or leaked intellectual property
...
- ✅ Certificate issued to [Your Company Name]
- ✅ Domain matches exactly (beware of typosquatting)

### Authorized Distribution Channels
- ✅ Direct download from [your-company].com
- ✅ Private Git repositories (licensed users only)
- ✅ Email delivery from @[your-company].com addresses

### UNAUTHORIZED Sources (DO NOT TRUST)
- ❌ Public GitHub repositories (unless official org)
- ❌ File-sharing sites (e.g., MediaFire, Mega)
- ❌ Torrent sites
- ❌ Third-party marketplaces
- ❌ Social media file attachments
- ❌ Unofficial mirrors
...
❌ **Absent (Red Flags for Counterfeits):**
